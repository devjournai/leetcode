/**
    ...
    * Time Complexity: O(N), where N is the number of enumerable properties in the object or elements in the array. This is due to `Object.entries()` needing to iterate over the properties/elements to construct the new array.
    * Space Complexity: O(N) to store the intermediate array generated by `Object.entries()`, where N is the number of enumerable properties or elements.
*/
