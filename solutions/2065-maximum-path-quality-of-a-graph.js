...
var maximalPathQuality = function (values, edges, maxTime) {
  ...
  function calculatePathQuality(
    currentNodePointer,
    remainingTravelTime,
    currentPathTotalQuality,
    nodesVisitedInPath
  ) {
    ...
    for (const [neighborNodeIndex, neighborEdgeDuration] of graphAdjacencyList[
      currentNodePointer
    ]) {
      ...
      calculatePathQuality(
        neighborNodeIndex,
        remainingTravelTime - neighborEdgeDuration,
        nextPathAccumulatedQuality,
        nextVisitedNodesSet
      );
    }
  }
