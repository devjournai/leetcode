...
-- Intuition: A successful same-team pass is +1 dominance and a turnover is -1. Split the match into first half [00:00, 45:00] and second half [45:01, 90:00].
-- Approach: Join Passes to Teams for passer and receiver, tag the half from time_stamp, then SUM(IF same team then 1 else -1) grouped by team and half.
