/**
    ...
    * Time Complexity: O(1) because the input number `n` is guaranteed to be 3 digits, meaning the lengths of `n`, `2*n`, `3*n`, and their concatenation are bounded by a small constant. String operations and array access are constant time.
    * Space Complexity: O(1) because a fixed-size boolean array (size 10) and string variables of bounded constant length are used regardless of the input value of `n` within its constraints.
*/
